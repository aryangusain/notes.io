...
export default function Home() {
  ...
  return (
    <div className={cn("min-h-screen flex flex-col justify-start items-center pt-[100px] px-[20px] gap-[20px] md:gap-[60px] bg-neutral-200 text-neutral-900 dark:bg-neutral-900 dark:text-neutral-100", (theme === "dark") && "dark")}>
      ...
      <h1 className="font-semibold text-[76px]/20 md:text-[132px] md:-mt-[20px] text-violet-600 ">Notes.io</h1>

      <p className="text-[10px] md:text-[16px] px-[40px] max-w-fit text-neutral-400 font-semibold text-center">
        A clean, fast note-taking app that lets you format with <br /> Markdown, turn notes into polished PDFs, and store <br />them securely in a database.
      </p>
      ...
      {session ? (
        ...
        >
          ...
          <span className="">Get Started with Google</span>
        </button>
      )}
    </div>
  );
